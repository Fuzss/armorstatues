...
public class ArmorStandRotationsScreen extends AbstractArmorStandScreen {
    ...
    protected void init() {
        super.init();
        this.addRenderableWidget(new TickButton(this.leftPos + 80, this.topPos + 135, 50, 20, Component.translatable("armorstatues.screen.rotations.reset"), CommonComponents.EMPTY, button -> {
            this.setCurrentPose(ArmorStandPose.NONE);
        })).setLastClickedTicksDelay(20);
        this.addRenderableWidget(new TickButton(this.leftPos + 80, this.topPos + 158, 50, 20, Component.translatable("armorstatues.screen.rotations." + (clampRotations ? "unclamp" : "clamp")), CommonComponents.EMPTY, button -> {
            clampRotations = !clampRotations;
            ((TickButton) button).setTitle(Component.translatable("armorstatues.screen.rotations." + (clampRotations ? "unclamp" : "clamp")));
        })).setLastClickedTicksDelay(20);
        this.addRenderableWidget(new TickButton(this.leftPos + 80, this.topPos + 10, 50, 20, Component.translatable("armorstatues.screen.rotations.copy"), CommonComponents.EMPTY, button -> {
            clipboard = this.currentPose;
        })).setLastClickedTicksDelay(20);
        this.addRenderableWidget(new TickButton(this.leftPos + 80, this.topPos + 33, 50, 20, Component.translatable("armorstatues.screen.rotations.paste"), CommonComponents.EMPTY, button -> {
