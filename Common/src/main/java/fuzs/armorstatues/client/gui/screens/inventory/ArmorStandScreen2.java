...
public class ArmorStandScreen2 extends AbstractContainerScreen<ArmorStandMenu> {
    ...
    public ArmorStandScreen2(ArmorStandMenu abstractContainerMenu, Inventory inventory, Component component) {
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pX, int pY) {
        ...
        InventoryScreen.renderEntityInInventory(i + 104, j + 84, 30, (float)(i + 104 + 3) - this.xMouse, (float)(j + 84 - 50) - this.yMouse, this.armorStand);
    }
