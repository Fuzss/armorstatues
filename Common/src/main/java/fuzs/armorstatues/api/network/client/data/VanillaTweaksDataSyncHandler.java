...
public class VanillaTweaksDataSyncHandler extends CommandDataSyncHandler {
    ...
    private static final int[] POSE_ADJUSTMENT_BODY = new int[]{POSE_ADJUSTMENT_BODY_X_NEGATIVE, POSE_ADJUSTMENT_BODY_X_POSITIVE, POSE_ADJUSTMENT_BODY_Y_NEGATIVE, POSE_ADJUSTMENT_BODY_Y_POSITIVE, POSE_ADJUSTMENT_BODY_Z_NEGATIVE, POSE_ADJUSTMENT_BODY_Z_POSITIVE};
    private static final int[] POSE_ADJUSTMENT_RIGHT_ARM = new int[]{POSE_ADJUSTMENT_RIGHT_ARM_X_NEGATIVE, POSE_ADJUSTMENT_RIGHT_ARM_X_POSITIVE, POSE_ADJUSTMENT_RIGHT_ARM_Y_NEGATIVE, POSE_ADJUSTMENT_RIGHT_ARM_Y_POSITIVE, POSE_ADJUSTMENT_RIGHT_ARM_Z_NEGATIVE, POSE_ADJUSTMENT_RIGHT_ARM_Z_POSITIVE};
    private static final int[] POSE_ADJUSTMENT_LEFT_ARM = new int[]{POSE_ADJUSTMENT_LEFT_ARM_X_NEGATIVE, POSE_ADJUSTMENT_LEFT_ARM_X_POSITIVE, POSE_ADJUSTMENT_LEFT_ARM_Y_NEGATIVE, POSE_ADJUSTMENT_LEFT_ARM_Y_POSITIVE, POSE_ADJUSTMENT_LEFT_ARM_Z_NEGATIVE, POSE_ADJUSTMENT_LEFT_ARM_Z_POSITIVE};
    private static final int[] POSE_ADJUSTMENT_RIGHT_LEG = new int[]{POSE_ADJUSTMENT_RIGHT_LEG_X_NEGATIVE, POSE_ADJUSTMENT_RIGHT_LEG_X_POSITIVE, POSE_ADJUSTMENT_RIGHT_LEG_Y_NEGATIVE, POSE_ADJUSTMENT_RIGHT_LEG_Y_POSITIVE, POSE_ADJUSTMENT_RIGHT_LEG_Z_NEGATIVE, POSE_ADJUSTMENT_RIGHT_LEG_Z_POSITIVE};
